...
```{r message = FALSE, warning = FALSE, echo = FALSE, fig.width = 16, fig.height = 13}
...
```{r echo = FALSE, message = FALSE, fig.width = 15, fig.height = 13}
TB_burden = read.csv("./data/TB_burden_countries.csv")
...
```{r message = FALSE, echo = FALSE, fig.width = 15, fig.height = 13}
TB_burden = read.csv("./data/TB_burden_countries.csv")
