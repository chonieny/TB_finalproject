---
title: "Graphs for Total Received Funding and Estimated Number of Deaths from TB 2017~2019"
output: 
  html_document:
    toc: true
    toc_float: true
...
```{Graph: Total funding received in each country in 2017-2019}
...
```{Graph: Estimated proportions of death from TB in each country in 2017~2019}
