...
After we plot the density graph, we noticed it was heavily right skewed. So, doing a log transformation made the density look more normal. So doing a log linear regression will help to predict the average hospital stay in 2020.
...
So when pluggin the average funding for each variables, we are  95% confident that the in 2020,  the average stay at the hospitals will fall between **-0.3268** and **5.75** days.
